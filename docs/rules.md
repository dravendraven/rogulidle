...
retorno decrescente por ponto. **O gasto até o fim aumenta a aposta nisso**:
o defeito antes aparecia em quem ficava clicando, e agora aparece em toda run
que ninguém assistiu. A ordem padrão não o resolve, só não o persegue — ela
gasta no caro primeiro, que é justamente a compra que rende menos por moeda. O consumível não conserta isso: ele compra a
